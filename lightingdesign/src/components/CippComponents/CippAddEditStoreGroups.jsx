...
import { CippFormStoreSelector } from "./CippFormStoreSelector";

const CippAddEditStoreGroups = ({ formControl, initialValues, title, backButtonTitle }) => {
  return (
    <CippFormSection
      ...
      relatedQueryKeys={["StoreGroupListPage"]}
      resetForm={false}
...
export default CippAddEditStoreGroups;
