  ...
  return (
    <>
      <Card {...other}>
        ...
        <PropertyList>
          <PropertyListItem divider label="Name" value={customer.name} />
          <PropertyListItem divider label="Email address" value={customer.email} />
          <PropertyListItem divider label="Phone" value={customer.phone} />
          <PropertyListItem label="Country" value={customer.country} />
          <PropertyListItem divider label="Street" value={customer.street} />
        </PropertyList>
        <Divider />
        <ActionList>
          <ActionListItem
