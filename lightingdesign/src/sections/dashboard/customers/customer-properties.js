...
export const CustomerProperties = (props) => {
  ...
  return (
    <Card {...other}>
      ...
      <Divider />
      <PropertyList>
        <PropertyListItem divider label="Tax Exempt" value={customer.isTaxExempt ? "Yes" : "No"} />
        <PropertyListItem divider label="Store Credit" value={storeCredit} />
        <PropertyListItem divider label="Status" value={customer.status} />
        <PropertyListItem label="Signup" value={createdAt} />
      </PropertyList>
    </Card>
  );
};
