...
export const InvoiceDetails = (props) => {
  ...
  return (
    <Card>
      ...
      >
        <PropertyList>
          <PropertyListItem label="Invoice Ref" value={invoice.ref} />
          <PropertyListItem label="Issue Date" value={issueDate} />
          <PropertyListItem label="Notes" value={`“${invoice.note}”`} />
        </PropertyList>
        <PropertyList>
          <PropertyListItem label="Customer Name" value={invoice.customer?.name} />
          <PropertyListItem label="Due Date" value={dueDate} />
        </PropertyList>
      </Stack>
    </Card>
  );
